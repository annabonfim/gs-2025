      ...
      <main className="bg-[#FDF7F0] min-h-screen px-6 py-10 flex flex-col items-center">
        <div className="max-w-3xl w-full space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link href="/dashboard/voluntario/cadastrar" className="block bg-white rounded-md shadow-md p-4 hover:shadow-lg">
              <h2 className="text-lg font-semibold text-[#0C3B5D] mb-2">Quero me voluntariar</h2>
              <p className="text-sm text-gray-600">Preencha seu perfil de voluntário com tipo de ajuda, disponibilidade e localização.</p>
            </Link>
